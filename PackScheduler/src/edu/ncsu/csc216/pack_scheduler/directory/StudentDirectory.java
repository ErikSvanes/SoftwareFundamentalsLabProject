...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException if file name isn't valid
	 */
	...
	/**
	 * Method to find student in directory by id. 
	 * @param id to find in directory. 
	 * @return s Student with matching id, returns null if a student with that id does not exist.
	 */
